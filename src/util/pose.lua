...
function saveHms(path, inp)
    local img1 = torch.cat({inp[1],inp[2],inp[3],inp[4]},2)
    local img2 = torch.cat({inp[5],inp[6],inp[7],inp[8]},2)
    local img3 = torch.cat({inp[9],inp[10],inp[11],inp[12]},2)
    local img4 = torch.cat({inp[13],inp[14],inp[15],inp[16]},2)
    image.save(path,torch.cat({img1,img2,img3,img4},1))
end
